...
<!-- badges: start -->
[![CRAN status](https://www.r-pkg.org/badges/version/git)](https://CRAN.R-project.org/package=git)
[![R build status](https://github.com/randy3k/git/workflows/R-CMD-check/badge.svg)](https://github.com/randy3k/git/actions)
